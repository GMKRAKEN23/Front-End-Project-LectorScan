    ...
    return (
        <div className='flex justify-around items-center h-full lg:h-full'>
            <div className="lg:w-4/12 lg:mx-3 mt-4 flex flex-col gap-3 items-stretch">
                <h2 className="text-3xl text-center md:text-5xl lg:text-6xl font-semibold text-neutral-50 tracking-widest">{name}</h2>
                <h3 className="text-2xl text-center md:text-4xl lg:text-4xl font-semibold text-neutral-50 tracking-widest">{chapter}</h3>
