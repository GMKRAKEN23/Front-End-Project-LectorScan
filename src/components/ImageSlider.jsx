        ...
        <Swiper
            ...
            <SwiperSlide>
                <section style={{
                    ...
                    led by the charismatic Luffy, pursue their ultimate dream: finding the legendary...' 
            ...
            <SwiperSlide>
                <section style={{
                    ...
                    him to a sword duel. The greatest swordsmen of the...' chapter='Chapter 980' date='10th January 2025'/>
                </section>
            </SwiperSlide>
            <SwiperSlide>
                <section style={{
                    ...
                    an...' chapter='Chapter 1044' date='30th May 2025'/>
                </section>
            </SwiperSlide>
        </Swiper>
    )
