...
function BestChapterManga() {
    ...
    return (
        <div>
            <div><h2 className="text-neutral-50 text-center tracking-widest font-bold py-5 text-2xl">Best chapter Manga</h2></div>
            {mangaData.map(( manga, index) => (
                <div key={index} className="flex items-center card w-auto h-32 sm:w-96 sm:h-32 border-2 rounded-xl my-5 px-4  bg-[#1d1e20] cursor-pointer">
