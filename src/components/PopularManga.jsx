    ...
    return (
        <div className="mt-10 mb-20">
            <div className="flex flex-col justify-start">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 cursor-pointer mx-auto">
                    {mangaData.map((manga, index) => (
                        <div key={index} className="max-w-sm w-72 h-96 border-2 flex flex-col justfify-between rounded-lg overflow-hidden shadow-lg bg-[#1d1e20] m-3 hover:scale-[102%] transform transition duration-300 ease-in-out shadow_custom_red-20  ">
