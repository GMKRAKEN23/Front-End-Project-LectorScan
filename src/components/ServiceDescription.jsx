function ServiceDescription() {
    return (
        <div className="h-auto my-6 lg:h-96">
            <div className="flex flex-col h-full place-content-evenly grid col-2 py-2">
                <div>
                    <h2 className="text-neutral-50 text-center font-semibold w-3/4 lg:w-3/5 mx-auto py-4 tracking-widest text-lg md:text-xl lg:text-2xl">LectorScan, your online gateway to a vast library of manga.</h2>
                ...
                <div className="grid grid-cols-2 gap-5 lg:flex lg:justfiy-between w-full-screen mx-auto lg:space-x-14 mx-2">
